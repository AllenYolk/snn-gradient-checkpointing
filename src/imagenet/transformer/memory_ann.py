...
def main():
    ...
    model_list = (
        net.conv_proj, net.encoder.dropout, net.encoder.layers, net.encoder.ln,
        net.heads
    )
    search_mode_list = ("self", "self", "direct_children", "self", "self")
    model_name_list = ("patch_embed", "dropout", "block", "ln", "head")
    profiler = MemoryProfilerList(
