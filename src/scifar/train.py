...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        wandb.log({
            ...
            "mem/peak_allocated": peak_allocated,
            "mem/peak_reserved": peak_reserved,
    ...
    if args.monitor_memory:
        ...
        peak_allocated = mem_stats["allocated_bytes.all.peak"] / (1024**2)
        peak_reserved = mem_stats["reserved_bytes.all.peak"] / (1024**2)
        wandb.summary["mem/overall_peak_allocated"] = peak_allocated
        wandb.summary["mem/overall_peak_reserved"] = peak_reserved
