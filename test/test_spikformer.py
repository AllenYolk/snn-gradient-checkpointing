...
def _test_spikformer_imagenet(net):
    set_seed(2025)
...
def test_spikformer_imagenet():
    net = models.Spikformer(
        "SJLIF",
        T=4,
        embed_dims=256,
        num_heads=8,
...
def test_spikformer_equality_imagenet():
    net1 = models.Spikformer(
        "SJLIF",
        T=4,
        embed_dims=256,
        num_heads=8,
...
if __name__ == "__main__":
    # test_spikformer_imagenet()
    # test_mespikformer_imagenet()
    test_spikformer_equality_imagenet()
